...
If a foreign language such as L<Aldor|aldor> or Perl includes a C FFI, Yaccpp
...
action code. This feature can be controlled using the C<%action-lang> directive.
