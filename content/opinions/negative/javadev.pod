...
I work at a small software company that primarily uses the Java programming
language for its development. While I have come to appreciate many features of
Java and its tooling, there are several things about the workflow I am
very unhappy about. On this page, I will describe some recent experience I have
had with web application development in Java.
...
demigods Java developers worship is Eclipse (another is Maven). Personally, I
tend to see the positive and negative sides of each piece of technology I use.

=head3 Positive about working with C++
...
=head3 Negative about working with C++
